...
public class TelaVenda extends javax.swing.JFrame {
    ...
    public TelaVenda(int verif) {
        ...
        ArrayList <Venda> listavenda = bancodao.mostraVenda(verif);
        
        for(Venda venda : listavenda){
            
              dtm_tabela.addRow(new Object[]{venda.getCod_venda(), venda.getCpf(), venda.getCod_res(), venda.getData().toString(), venda.getValor()});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código Venda", "CPF", "Código da Residência", "Data de Venda", "Valor Venda"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVenda(0).setVisible(true);
            }
        });
    }
